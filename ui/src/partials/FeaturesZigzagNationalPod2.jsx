...
import HeroImage from '../images/kg_pod.jpg';

function FeaturesZigzagNationalPod2() {
  ...
  var videoName = "/videos/kg_lutron.mp4";
            ...
            <Modal id="modal" ariaLabel="modal-headline" show={videoModalOpen} handleClose={() => setVideoModalOpen(false)}>
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <h3 className="h3 mb-3">Podcast modified with Ads (1)</h3>
                </div>
              </div>
            </div>
          </div>
...
export default FeaturesZigzagNationalPod2;